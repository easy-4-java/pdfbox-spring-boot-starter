...
**Spring Boot Starter for pdfbox**

[![Maven Central](https://img.shields.io/maven-central/v/io.github.easy4j/pdfbox-spring-boot-starter)](https://github.com/easy-4-java/pdfbox-spring-boot-starter)
...
> **Artifact ID**：`pdfbox-spring-boot-starter`<br>
> **License**：Apache License 2.0<br>

## 1. Positioning

**pdfbox-spring-boot-starter** is a Spring Boot starter that integrates **pdfbox** for applications using pdfbox. It provides auto-configuration, property binding, and ready-to-use beans so that applications can consume pdfbox capabilities with minimal setup.

| Dimension | Description |
|---|---|
| Type | Spring Boot Starter |
| Consumers | Spring Boot applications using pdfbox |
| Core Capabilities | auto-configuration, property binding, ready-to-use beans for pdfbox |
| JDK | `17` |
| Coordinates | `io.github.easy4j:pdfbox-spring-boot-starter:3.4.x.20260527-SNAPSHOT` |
| Config Prefix | `pdfbox` |

## 2. Core Capabilities

| Capability | Status | Description |
|---|:---:|---|
| Auto-configuration | ✅ Stable | Registers pdfbox beans automatically |
| Property Binding | ✅ Stable | Binds `pdfbox.*` to `Properties` |
...
<dependency>
    ...
    <artifactId>pdfbox-spring-boot-starter</artifactId>
...
|---|---|---|:---:|---|:---:|
| `pdfbox.enabled` | boolean | `true` | No | Enable the starter | No |
...
```bash
mvn clean verify
mvn -pl pdfbox-spring-boot-starter -am test
```
...
|---|---|---|
| Bean not created | Check auto-configuration report | Verify `pdfbox.enabled=true` and classpath |
...
[Back to top](#readme-top) · [Issues](https://github.com/easy-4-java/pdfbox-spring-boot-starter/issues) · [Repository](https://github.com/easy-4-java/pdfbox-spring-boot-starter)
